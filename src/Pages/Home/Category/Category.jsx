...
const Category = () => {
    return (
        ...
        >
            ...
            <SwiperSlide>
                <img src={slide2} alt="" />
                <h3 className="text-2xl uppercase text-center -mt-16 text-white">Pizza</h3>
            </SwiperSlide>
            <SwiperSlide>
                <img src={slide3} alt="" />
            ...
            <SwiperSlide>
                <img src={slide4} alt="" />
                <h3 className="text-2xl uppercase text-center -mt-16 text-white">Cake</h3>
            </SwiperSlide>
            <SwiperSlide>
                <img src={slide5} alt="" />
                <h3 className="text-2xl uppercase text-center -mt-16 text-white">Burger</h3>
            </SwiperSlide>
        </Swiper>
        </section>
    )
